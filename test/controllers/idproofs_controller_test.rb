...
class IdproofsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create idproof" do
    assert_difference("Idproof.count") do
      post idproofs_url, params: { idproof: { doctype: @idproof.doctype, document: @idproof.document } }
    end
  ...
  test "should update idproof" do
    patch idproof_url(@idproof), params: { idproof: { doctype: @idproof.doctype, document: @idproof.document } }
